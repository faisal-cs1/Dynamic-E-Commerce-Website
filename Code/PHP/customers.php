...
<body>
    ...
    <div id="main" class="main">
        ...
        <div class="add-button">
            <button id="add-customer" class="add-customer" onclick="addCustomer()">Add Customer</button>
        </div>
        <div id="signUp-container" class="signUp-container">
            <form action="../PHP/addCustomer.php" method="POST" class="signUpForm" id="signUpForm">
